...
export default function PlanningSpreadsheet() {
  ...
  useEffect(() => {
    const initialSalesCategories: CategoryItem[] = [
      { id: "sales-1", name: "Direct Sales", level: "major", parentId: null, values: {}, isExpanded: true },
      { id: "sales-1-1", name: "Product A", level: "medium", parentId: "sales-1", values: {}, isExpanded: true },
      { id: "sales-1-1-1", name: "Online", level: "minor", parentId: "sales-1-1", values: {} },
      { id: "sales-1-1-2", name: "Retail", level: "minor", parentId: "sales-1-1", values: {} },
      { id: "sales-1-2", name: "Product B", level: "medium", parentId: "sales-1", values: {}, isExpanded: true },
      { id: "sales-1-2-1", name: "Online", level: "minor", parentId: "sales-1-2", values: {} },
      { id: "sales-2", name: "Indirect Sales", level: "major", parentId: null, values: {}, isExpanded: true },
      { id: "sales-2-1", name: "Partnerships", level: "medium", parentId: "sales-2", values: {}, isExpanded: true },
      { id: "sales-2-1-1", name: "Referrals", level: "minor", parentId: "sales-2-1", values: {} },
    ]

    const initialExpenseCategories: CategoryItem[] = [
      { id: "exp-1", name: "Operating Expenses", level: "major", parentId: null, values: {}, isExpanded: true },
      { id: "exp-1-1", name: "Salaries", level: "medium", parentId: "exp-1", values: {}, isExpanded: true },
      { id: "exp-1-1-1", name: "Full-time", level: "minor", parentId: "exp-1-1", values: {} },
      { id: "exp-1-1-2", name: "Part-time", level: "minor", parentId: "exp-1-1", values: {} },
      { id: "exp-1-2", name: "Office", level: "medium", parentId: "exp-1", values: {}, isExpanded: true },
      { id: "exp-1-2-1", name: "Rent", level: "minor", parentId: "exp-1-2", values: {} },
      { id: "exp-1-2-2", name: "Utilities", level: "minor", parentId: "exp-1-2", values: {} },
      { id: "exp-2", name: "Marketing", level: "major", parentId: null, values: {}, isExpanded: true },
      { id: "exp-2-1", name: "Advertising", level: "medium", parentId: "exp-2", values: {}, isExpanded: true },
      { id: "exp-2-1-1", name: "Online", level: "minor", parentId: "exp-2-1", values: {} },
      { id: "exp-2-1-2", name: "Print", level: "minor", parentId: "exp-2-1", values: {} },
    ]
